...
public class TeacherController {
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Teacher found", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TeacherDto.class))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "201", description = "Teacher created", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TeacherDto.class))),
    ...
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Teacher updated", content = @Content(mediaType = "application/json", schema = @Schema(implementation = TeacherDto.class))),
            @ApiResponse(responseCode = "400", description = "Validation failed", content = @Content),
            @ApiResponse(responseCode = "404", description = "Teacher not found", content = @Content)
    })
    @PutMapping("/{id}")
    public ResponseEntity<TeacherDto> updateTeacher(@Parameter(description = "Id of the teacher") @PathVariable int id, @RequestBody TeacherDto teacherDto) {
    ...
    public ResponseEntity<Void> addSubjectToTeacher(@Parameter(description = "Id of the teacher") @PathVariable int id, @Valid @RequestBody SubjectDto dto) {
        service.addSubjectToTeacher(id, dto);
        return new ResponseEntity<>(HttpStatus.OK);
    }

    @Operation(summary = "Get all subjects of teacher", description = "Returns a list of subjects of a teacher. If there is no teacher with such id, returns 404.")
    @ApiResponses({
    ...
    @Operation(summary = "Delete subject from teacher", description = "Deletes a subject from a teacher. If there is no teacher with such id, returns 404.")
    @ApiResponses({
    ...
    public ResponseEntity<Void> deleteSubjectOfTeacher(@Parameter(description = "Id of the teacher") @PathVariable int id,@Parameter(description = "Id of the subject") @RequestParam int subjectId) {
        service.deleteSubjectOfTeacher(id, subjectId);
        return new ResponseEntity<>(HttpStatus.NO_CONTENT);
    }

    @Operation(summary = "Get all students of teacher", description = "Returns a list of students of a teacher. If there is no teacher with such id, returns 404.")
    @ApiResponses({
    ...
    public ResponseEntity<Void> addStudentToTeacher(@Parameter(description = "Id of the teacher") @PathVariable int id,@Parameter(description = "Id of the student") @RequestParam int studentId) {
        service.addStudentToTeacher(id, studentId);
        return new ResponseEntity<>(HttpStatus.OK);
    }
    @Operation(summary = "Delete student from teacher", description = "Deletes a student from a teacher. If there is no teacher with such id, returns 404.")
    @ApiResponses({
            @ApiResponse(responseCode = "204", description = "Student deleted", content = @Content),
            @ApiResponse(responseCode = "404", description = "Teacher or student not found", content = @Content)
    })
    @DeleteMapping("/{id}/students")
    public ResponseEntity<Void> deleteStudentOfTeacher(@Parameter(description = "Id of the teacher") @PathVariable int id,@Parameter(description = "Id of the student") @RequestParam int studentId) {
